...
class GetLicenceImagePage extends StatefulWidget {
  const GetLicenceImagePage({super.key});

  @override
  GetLicenceImagePageState createState() => GetLicenceImagePageState();
}

class GetLicenceImagePageState extends State<GetLicenceImagePage> {
  XFile? _image;
