...
class RegisterLicencePage extends StatefulWidget {
  final XFile? driverImage;

  const RegisterLicencePage({super.key, this.driverImage});

  @override
  RegisterLicencePageState createState() => RegisterLicencePageState();
}

class RegisterLicencePageState extends State<RegisterLicencePage> {
  XFile? _driverImage;

  Future<void> _navigateToGetDriverImagePage() async {
    final XFile? image = await Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => const GetLicenceImagePage()),
    );
  ...
  Future<void> _onPressedNextButton() async {
    ...
    Navigator.push(context,
        MaterialPageRoute(builder: (context) => const RegisterVchiclePage()));
  }
